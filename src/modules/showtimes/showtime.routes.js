...
const { createShowTimeValidator, showTimeByIdValidator } = require('./showtime.validator');
const { createShowTime, viewShowTimes, deleteShowTime, updateShowTime, viewShowTimesPublic, showTimesBelongMovie } = require('./showtime.controller');
