...
const { createMovie, deleteMovie, viewMovies, viewMovie, updateMovie, viewMoviesPublic, uploaderSupabase, viewMoviePublic, imageUploaderMovie, resizeImage } = require('../controllers/movieController');
